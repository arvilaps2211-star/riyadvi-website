    ...
    <>
      ...
      <section className="border-b border-border bg-background py-14 sm:py-16">
        <Container>
          ...
          <div className="mt-12 aspect-[21/9] border border-border bg-[linear-gradient(135deg,rgba(212,175,55,0.1),transparent_50%,rgba(13,13,13,1))]">
            <div className="flex h-full items-end p-6">
              <p className="text-xs uppercase tracking-[0.16em] text-muted">
                Visuals — brand and product presentation
              </p>
            </div>
          </div>
        </Container>
